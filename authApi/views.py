...
def eventApi(request):
    ...
    if 1: #try:
        ...
        for parentEvent in parentEvents:
            ...
            pEventData['subsidiary_industry_id'] = y
            pEventData['subsidiary_industry_name'] = parentEvent.categoryName
            # pEventData['description'] = parentEvent.description
            # pEventData['event_content'] = parentEvent.description
            #pEventData['order'] = parentEvent.order
            #pEventData['events'] = []
            pEventData['subsidiaries'] = []
            ...
            for event in events:
                ...
                eventData['wp_id'] = y+x
                eventData['subsidiary_id'] = y+x
                eventData['subsidiary_locations'] = []
                eventData['subsidiary_image'] = "hideme"
                ...
                pEventData['subsidiaries'].append(eventData)
            y += 1000
